  ...
  return (
    <section data-section-id="teilen" className="bg-[#111] py-16 md:py-24 border-t border-white/10">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <p className="font-body text-white/70 text-lg leading-relaxed mb-8 max-w-2xl">
        ...
        <div className="flex flex-wrap gap-3">
          {canNativeShare && (
            <button
              ...
              className="inline-flex items-center gap-2 border border-white/20 px-5 py-3 font-section text-sm tracking-wider text-white hover:border-white/50 hover:bg-white/5 transition-colors"
            >
              <Share2 size={16} />
              Instagram & mehr
            </button>
