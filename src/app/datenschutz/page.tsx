        ...
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-sm space-y-8">
            ...
            <section>
              ...
              <div className="font-body text-pause-black/80 mt-2 space-y-1">
                <p>Benjamin Schmidt</p>
                <p>Burgemeisterstraße 30</p>
                <p>c/o Coordes</p>
                <p>12103 Berlin</p>
              ...
              <div className="font-body text-pause-black/80 text-justify bg-pause-gray-light p-4 rounded-lg mt-2">
                <p>
            ...
            <section>
              ...
              <p className="font-body text-pause-black/80 mt-2 text-justify">
                ...
                <a href="https://developers.google.com/fonts/faq" target="_blank" rel="noopener noreferrer" className="orange-link">
                  https://developers.google.com/fonts/faq
                </a>{" "}
                und in der Datenschutzerklärung von Google:{" "}
                <a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer" className="orange-link">
            ...
            {/* Quelle */}
            <section className="border-t border-pause-black/10 pt-6">
              <p className="font-body text-pause-black/50 text-sm">
                Quelle:{" "}
                <a href="https://www.e-recht24.de" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF9416] transition-colors">
