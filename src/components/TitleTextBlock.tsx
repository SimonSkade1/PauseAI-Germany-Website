...
export default function TitleTextBlock({
  ...
  return (
    <div id={id} className={className}>
      ...
      <span className="font-headline text-base md:text-2xl text-black block mb-2">
        {smallHeading}
      </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12">
        ...
        <h2 className="font-headline text-2xl md:text-5xl lg:text-6xl text-black leading-tight">
          {largeHeading}
        </h2>
